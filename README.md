...
!["git add ." command](screenshots/task4-git-add.png)

## 2. "git commit -m "Initial commit" " This command commits the added code. and now is ready to push to github.
!["git commit" command](screenshots/task4-git-commit.png)

## 3. "github repo created" github repository was created.
![github repo created](screenshots/task4-github-repo-created.png)
...
![git branches](screenshots/task4-git-dev-branch.png)
![git branches](screenshots/task4-git-feature-branch.png)

## 5. merging the changes.
![git branches merge](screenshots/task4-git-new-feature-dev-merge-pull-request.png)
![git branches merge](screenshots/task4-merge-into-main-success.png)
![git branches merge](screenshots/task4-merge-pull-req.png)
![git branches merge](screenshots/task4-merging-dev-into-main.png)
![git branches merge](screenshots/task4-new-feature-pull-request-before.png)
